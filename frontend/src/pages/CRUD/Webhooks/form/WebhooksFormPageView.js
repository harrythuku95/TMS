...
import WebhooksFormView from 'pages/CRUD/Webhooks/form/WebhooksFormView';
import { push } from 'connected-react-router';
import actions from 'actions/webhooks/webhooksFormActions';
import { connect } from 'react-redux';

const WebhooksFormPageView = (props) => {
...
export default connect(mapStateToProps)(WebhooksFormPageView);
