...
import MessagesFormView from 'pages/CRUD/Messages/form/MessagesFormView';
import { push } from 'connected-react-router';
import actions from 'actions/messages/messagesFormActions';
import { connect } from 'react-redux';

const MessagesFormPageView = (props) => {
...
export default connect(mapStateToProps)(MessagesFormPageView);
