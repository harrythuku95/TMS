...
import actionsMessages from 'actions/messages/messagesFormActions';
...
const MessagesTable = () => {
  ...
  const [filters, setFilters] = useState([
    { label: 'message_id', title: 'message_id' },
  ]);
  ...
  const update = (id, data) => {
    dispatch(actionsMessages.doUpdate(id, data));
  };
  ...
  return (
    <div>
      <Widget title={humanize('Messages')} disableWidgetMenu>
        <Box className={classes.actions}>
          <Link to='/admin/messages/new' className={classes.element}>
