...
import MailboxesFormView from 'pages/CRUD/Mailboxes/form/MailboxesFormView';
import { push } from 'connected-react-router';
import actions from 'actions/mailboxes/mailboxesFormActions';
import { connect } from 'react-redux';

const MailboxesFormPageView = (props) => {
...
export default connect(mapStateToProps)(MailboxesFormPageView);
