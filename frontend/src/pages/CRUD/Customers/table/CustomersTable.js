...
import actionsCustomers from 'actions/customers/customersFormActions';
...
const CustomersTable = () => {
  ...
  const [filters, setFilters] = useState([
    { label: 'customer_id', title: 'customer_id' },
  ]);
  ...
  const update = (id, data) => {
    dispatch(actionsCustomers.doUpdate(id, data));
  };
  ...
  return (
    <div>
      <Widget title={humanize('Customers')} disableWidgetMenu>
        <Box className={classes.actions}>
          <Link to='/admin/customers/new' className={classes.element}>
