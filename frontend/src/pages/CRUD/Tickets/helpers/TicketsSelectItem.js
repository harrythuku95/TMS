...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/tickets/autocomplete`, { params });
  return response.data;
}

const TicketsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.tickets.hasPermissionToCreate,
});

export default connect(select)(TicketsSelectItem);
