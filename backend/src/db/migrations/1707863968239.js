module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('webhooks', 'webhook_id', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('ticket_labels', 'label_id', {
        transaction,
      });

      await queryInterface.removeColumn('ticket_counts', 'count_id', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('mailboxes', 'mailbox_id', {
        transaction,
      });

      await queryInterface.removeColumn('folders', 'folder_id', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('attachments', 'attachment_id', {
        transaction,
      });
